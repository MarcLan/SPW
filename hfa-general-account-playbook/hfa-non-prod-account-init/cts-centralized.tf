...
module "nonprod_cts_centralized" {
  ...
  collected_account_name = module.global_variables.nonprod_env_root_account_name
  collected_access_key = module.global_variables.nonprod_env_account_ak
  collected_secret_key = module.global_variables.nonprod_env_account_sk
